...
async def home():
    ...
    <head>
        ...
        <style>
            ...
            label { display: block; text-align: left; font-size: 12px; color: #94a3b8; margin-bottom: 6px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; }
            .input-group {
                position: relative;
                display: flex;
                align-items: center;
    ...
    <body>
        <div class="container">
            ...
            <div class="converter-box">
                ...
                <div class="input-group">
                    <span class="currency-flag" id="baseFlag">🇺🇸</span>
                ...
                <label>Amount</label>
                <div class="input-group">
                    <span class="currency-flag" id="inputFlag">🇺🇸</span>
        ...
        <script>
            function updateElements() {
                ...
                document.getElementById('baseFlag').innerText = flag;
                document.getElementById('inputFlag').innerText = flag;
